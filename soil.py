...
class Plant(pygame.sprite.Sprite):
	def __init__(self, plant_type, groups, soil, check_watered):
		...
		self.frames = import_folder(f'./graficos/fruit/{plant_type}')
		self.soil = soil
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        # graphics
        self.soil_surfs = import_folder_dict('./graficos/soil/')
        self.water_surfs = import_folder('./graficos/soil_water')

        self.create_soil_grid()
        self.create_hit_rects()

    def create_soil_grid(self):
        ground = pygame.image.load('./graficos/world/ground.png')
